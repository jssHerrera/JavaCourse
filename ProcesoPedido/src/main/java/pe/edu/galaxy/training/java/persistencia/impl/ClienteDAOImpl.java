package pe.edu.galaxy.training.java.persistencia.impl;
...
public class ClienteDAOImpl implements ClienteDAO {
	...
	public boolean insertar(Cliente cliente) throws PersistenciaException {
		try {
			...
			String sql = "INSERT INTO CLIENTE(CLIENTE_ID,RAZON_SOCIAL,NRO_DOCUMENTO,CORREO,DIRECCION,ID_PAIS,"
					+ "AUD_TIPO,AUD_IDUSUARIO,AUD_SESION,AUD_IP,AUD_FECHA)" + "VALUES(SEQ_CLIENTE.NEXTVAL,?,?,?,?,?,"
					+ "'I',?,?,?,SYSDATE)";
			PreparedStatement ps = cn.prepareStatement(sql);
	...
	@Override
	public boolean actualizar(Cliente t) throws PersistenciaException {
		// TODO Auto-generated method stub
		return false;
	}
	...
	@Override
	public Optional<Cliente> buscarClienteXNroDocumento(String nroDocumento) throws PersistenciaException {
		...
		return Optional.ofNullable(cliente);
			...
			throw new PersistenciaException ("Error al buscar cliente por numero de Documento" + e.getMessage());
		}
